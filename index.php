        ...
        <div class="row gx-5 align-items-center justify-content-center">
            <div class="col-lg-8 col-xl-7 col-xxl-6">
                <div class="my-5 text-center text-xl-start">
                    <h1 class="display-5 fw-bolder text-white mb-2">Taman Ria Suropati</h1>
                    <p class="lead fw-normal text-white-50 mb-4">Tiket Taman Ria Suropati kini bisa dipesan kapanpun dan diamanapun hanya dengan melalui gadget anda.</p>
                    <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                        <a class="btn btn-primary btn-lg px-4 me-sm-3" href="pemesanan.php">Pesan Tiket</a>
                        <a class="btn btn-outline-light btn-lg px-4" href="daftar.php">Bergabung</a>
                    </div>
                </div>
            </div>
